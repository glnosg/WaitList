...
class SwipeController extends Callback {
    ...
    private SwipeControllerAction buttonAction = null;
    ...
    private void setTouchListener(
        ...
        recyclerView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (swipeBack) {
                    if (dX > buttonWidth)
                        buttonShowedState  = ButtonsState.BUTTON_VISIBLE;
        ...
        recyclerView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    if (buttonAction != null && buttonInstance != null
                            && buttonInstance.contains(event.getX(), event.getY())) {

                        if (buttonShowedState == ButtonsState.BUTTON_VISIBLE) {

                            long id = (long) currentItemViewHolder.itemView.getTag();
                            buttonAction.onButtonClicked(id);
                        }
                    }
